...
public class DomainEventConverterTests
{
    ...
    public void ReadJson_ValidJson_ReturnsDomainEvent()
    {
        ...
        var assemblyQualifiedTypeName = "BuildingBlocks.Serialization.Tests.TestDomainEventWithAttribute, BuildingBlocks.Serialization.Tests, Version\u003d1.0.0.0, Culture\u003dneutral, PublicKeyToken\u003dnull";
        var serializedEvent = $$"""
                                {
                                  "Id": "{{id}}",
    ...
    public void ReadJson_ValidJson_ReturnsDomainEvent2()
    {
        ...
        var assemblyQualifiedTypeName = "BuildingBlocks.Serialization.Tests.TestDomainEventWithoutAttribute, BuildingBlocks.Serialization.Tests, Version\u003d1.0.0.0, Culture\u003dneutral, PublicKeyToken\u003dnull";
        var serializedEvent = $$"""
                                {
                                  "Id": "{{id}}",
                                  "CausationId": "{{causationId}}",
